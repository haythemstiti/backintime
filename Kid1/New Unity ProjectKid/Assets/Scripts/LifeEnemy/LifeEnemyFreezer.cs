...
public class LifeEnemyFreezer : MonoBehaviour
{
    ...
    void OnTriggerEnter(Collider other)
    {
        ...
        if (other.gameObject.tag.Equals("sword"))
        {
            ...
            if (life <= 0)
            {
                ...
                Photonstate.typeMonsterLife = 2;
                //new photon
                //DemoGame.getInstance().SendMonsterLife(true,cubeScript.cubeNumber,2);
            ...
            else
            {
                ...
                if (MisteryBoxWeapon.isElectricity)
                {
                    life -= 8;
